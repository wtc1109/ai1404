...
if None != cur:
    ...
    for _hvpd in _hvpds:
        ...
        _lines.append((_online1[4], _sn1_a,_cmos1_a,_aiout,_color, _reout))
...
<p><font size="5" color="%s">%s</font></p>
<p>%s</p><p>%s</p><p>%s</p></td>
            """%(_line[0],_line[4],_line[1],_line[2],_line[4],_line[3], _line[5][0], _line[5][1], _line[5][2])
            _pos = 1
        elif 1 == _pos:
            print """
            <td><img src="http://%s/images/ai0.jpg" width="200", hight="200" /></td>
