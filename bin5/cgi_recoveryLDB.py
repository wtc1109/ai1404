...
if os.path.exists("../sqlback"):
    os.system("mysqldump -ubluecardsoft -p#$%_BC13439677375 hvpd3db2 > ../sqlback2")
    os.system("mysql -ubluecardsoft -p#$%_BC13439677375 hvpd2db2_backup < ../sqlback2")
    os.remove("../sqlback2")
    os.system("mysql -ubluecardsoft -p#$%_BC13439677375 hvpd3db2 < ../sqlback")
    os.remove("../sqlback")
